...
export const AUDIT_LOGGING_ENTITY_ACTION_CONTRIBUTORS =
  new InjectionToken<EntityActionContributors>('AUDIT_LOGGING_ENTITY_ACTION_CONTRIBUTORS');

export const AUDIT_LOGGING_TOOLBAR_ACTION_CONTRIBUTORS =
  new InjectionToken<ToolbarActionContributors>('AUDIT_LOGGING_TOOLBAR_ACTION_CONTRIBUTORS');
