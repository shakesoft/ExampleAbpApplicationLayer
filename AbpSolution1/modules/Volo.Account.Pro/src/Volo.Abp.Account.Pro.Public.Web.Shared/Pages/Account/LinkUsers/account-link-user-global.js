(function ($) {
    ...
    var linkedAccounts = new abp.ModalManager(abp.appPath + "Account/LinkUsers/LinkUsersModal?returnUrl=" + location.pathname + location.search);
    ...
    $(function() {
        $('[id=MenuItem_Account_LinkedAccounts]')
            .removeClass("d-none")
            .click(function() {
                linkedAccounts.open();
            });
        ...
        .addContributor(function (actionList) {
            return actionList.addManyTail([
                ...
                },
                {
                    ...
                    action: function (data) {
                        volo.abp.account.identityLinkUser
                            .unlink({
