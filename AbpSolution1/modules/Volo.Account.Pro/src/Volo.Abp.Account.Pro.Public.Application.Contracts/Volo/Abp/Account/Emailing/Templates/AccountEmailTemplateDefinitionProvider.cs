...
public class AccountEmailTemplateDefinitionProvider : TemplateDefinitionProvider
{
    public override void Define(ITemplateDefinitionContext context)
    {
        ...
        context.Add(
            new TemplateDefinition(
                AccountEmailTemplates.EmailConfirmationCode,
                displayName: LocalizableString.Create<AccountResource>($"TextTemplate:{AccountEmailTemplates.EmailConfirmationCode}"),
                layout: StandardEmailTemplates.Layout,
                localizationResource: typeof(AccountResource)
            ).WithVirtualFilePath("/Volo/Abp/Account/Emailing/Templates/EmailConfirmationCode.tpl", true)
        );
    }
}
