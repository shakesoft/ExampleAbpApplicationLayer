...
(function(){
  ...
  (function(){
    ...
    volo.abp.account.accountSettings.getIdle = function(ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account-admin/settings/idle',
        type: 'GET'
      }, ajaxParams));
    };

    volo.abp.account.accountSettings.updateIdle = function(input, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account-admin/settings/idle',
        type: 'PUT',
        dataType: null,
