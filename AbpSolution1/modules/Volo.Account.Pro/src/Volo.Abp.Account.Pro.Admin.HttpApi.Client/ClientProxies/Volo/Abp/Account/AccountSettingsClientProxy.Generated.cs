...
public partial class AccountSettingsClientProxy : ClientProxyBase<IAccountSettingsAppService>, IAccountSettingsAppService
{
    ...
    {
        return await RequestAsync<AccountIdleSettingsDto>(nameof(GetIdleAsync));
    }

    public virtual async Task UpdateIdleAsync(AccountIdleSettingsDto input)
    {
        await RequestAsync(nameof(UpdateIdleAsync), new ClientProxyRequestTypeValue
        {
            { typeof(AccountIdleSettingsDto), input }
        });
    }
}
