...
public partial class AccountClientProxy : ClientProxyBase<IAccountAppService>, IAccountAppService
{
    ...
    {
        await RequestAsync(nameof(SendEmailConfirmationCodeAsync), new ClientProxyRequestTypeValue
        {
            { typeof(SendEmailConfirmationCodeDto), input }
        });
    }

    public virtual async Task<EmailConfirmationCodeLimitDto> GetEmailConfirmationCodeLimitAsync(string emailAddress)
    {
        return await RequestAsync<EmailConfirmationCodeLimitDto>(nameof(GetEmailConfirmationCodeLimitAsync), new ClientProxyRequestTypeValue
        {
