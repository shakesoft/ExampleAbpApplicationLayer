...
(function(){
  ...
  (function(){
    ...
    volo.abp.account.account.sendEmailConfirmationCode = function(input, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account/send-email-confirmation-code',
        type: 'POST',
        dataType: null,
        data: JSON.stringify(input)
      }, ajaxParams));
    ...
    volo.abp.account.account.getEmailConfirmationCodeLimit = function(emailAddress, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account/email-confirmation-code-limit' + abp.utils.buildQueryString([{ name: 'emailAddress', value: emailAddress }]) + '',
        type: 'GET'
      }, ajaxParams));
    };
