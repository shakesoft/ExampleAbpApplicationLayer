...
public static class AuthenticationBuilderExtensions
{
        ...
        where THandler : RemoteAuthenticationHandler<TOptions>
    {
        ...
        authenticationBuilder.Services.Replace(new ServiceDescriptor(typeof(THandler),
            provider => ActivatorUtilities.CreateInstance<AbpAccountAuthenticationRequestHandler<TOptions, THandler>>(
                provider, (THandler)ActivatorUtilities.CreateInstance(provider, typeof(THandler))),
