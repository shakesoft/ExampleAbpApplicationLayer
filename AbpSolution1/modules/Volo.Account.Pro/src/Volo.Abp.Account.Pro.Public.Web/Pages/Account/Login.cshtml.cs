...
public class LoginModel : AccountPageModel
{
    ...
    public virtual async Task<IActionResult> OnGetExternalLoginCallbackAsync(string remoteError = null)
    {
        ...
        if (await ShouldAskUserPasswordAsync(loginInfo))
        {
    ...
    protected async override Task<IActionResult> CheckLocalLoginAsync()
    {
    ...
    protected virtual async Task<bool> ShouldAskUserPasswordAsync(ExternalLoginInfo loginInfo)
    {
