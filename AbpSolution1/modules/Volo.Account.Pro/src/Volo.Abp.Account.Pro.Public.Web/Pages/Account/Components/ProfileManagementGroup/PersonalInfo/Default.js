(function ($) {
    ...
    $(function () {
        ...
        if ($("#timezone-select").length) {
            var select2 = null;
            volo.abp.account.profile.getTimezones().then(function (result) {
                ...
                volo.abp.account.profile.get().then(function (result) {
                    select2.val(result.timezone).trigger("change");
                });
            });
        }
