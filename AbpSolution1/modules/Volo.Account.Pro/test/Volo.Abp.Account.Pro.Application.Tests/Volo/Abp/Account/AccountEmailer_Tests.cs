...
#pragma warning disable 4014
        _emailSender.Received().QueueAsync("john.nash@abp.io", _stringLocalizer["PasswordReset"], Arg.Is<string>(x => x.Contains("TestPasswordResetToken")));
...
#pragma warning disable 4014
        _emailSender.Received().QueueAsync("john.nash@abp.io", _stringLocalizer["EmailConfirmation"], Arg.Is<string>(x => x.Contains("TestEmailConfirmationToken")));
#pragma warning restore 4014
    }
}
