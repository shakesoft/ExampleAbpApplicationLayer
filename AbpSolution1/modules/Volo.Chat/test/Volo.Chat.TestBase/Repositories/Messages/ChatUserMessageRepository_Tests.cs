    ...
    where TStartupModule : IAbpModule
{
    ...
    protected ChatUserMessageRepository_Tests()
    {
    ...
    [Fact]
    public async Task HasConversationAsync()
    {
        var hasConversation = await _repository.HasConversationAsync(_chatTestData.User1Id, _chatTestData.User2Id);
        hasConversation.ShouldBeTrue();
    }
}
