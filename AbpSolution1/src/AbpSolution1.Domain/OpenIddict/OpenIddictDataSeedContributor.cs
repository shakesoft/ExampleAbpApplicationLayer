...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //MAUI Client
        var mauiClientId = configurationSection["AbpSolution1_Maui:ClientId"];
        if (!mauiClientId.IsNullOrWhiteSpace())
        {
            var mauiClientRootUrl = configurationSection["AbpSolution1_Maui:RootUrl"]?.Replace("_", "-");
            var mauiClientCallbackUri = configurationSection["AbpSolution1_Maui:CallbackUri"]?.Replace("_", "-");
            var mauiClientPostLogoutRedirectUri = configurationSection["AbpSolution1_Maui:PostLogoutRedirectUri"]?.Replace("_", "-");
            await CreateApplicationAsync(
                ...
                scopes: commonScopes,
                redirectUris: new List<string> { mauiClientRootUrl , mauiClientCallbackUri },
                postLogoutRedirectUris: new List<string> { mauiClientPostLogoutRedirectUri }
            );
        }
        ...
        var webPublicTieredClientId = configurationSection["AbpSolution1_Web_Public:ClientId"];
        if (!webPublicTieredClientId.IsNullOrWhiteSpace())
        {
            var webPublicTieredRootUrl = configurationSection["AbpSolution1_Web_Public:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["AbpSolution1_Web_Public:ClientSecret"] ?? "1q2w3e*",
