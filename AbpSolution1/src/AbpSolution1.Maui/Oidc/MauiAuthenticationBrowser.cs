...
public class MauiAuthenticationBrowser : IBrowser, ITransientDependency
{
    ...
    public MauiAuthenticationBrowser(IConfiguration configuration)
    {
...
#if ANDROID
            webAuthenticatorOptions.CallbackUrl = new Uri(_configuration["Oidc:Options:PostLogoutRedirectUri"]!);
#endif
