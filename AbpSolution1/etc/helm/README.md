...
```
127.0.0.1 abpsolution1-local-web
127.0.0.1 abpsolution1-local-webgateway
127.0.0.1 abpsolution1-local-authserver
```
...
Now, you can browse the URL: `https://abpsolution1-local-web`
